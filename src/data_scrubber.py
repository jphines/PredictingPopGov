...
def main():
  path = '../usagov_data/'
  low = csv.writer(open('../tsv/low' + '.tsv', 'wb'), delimiter='\t')
  medium = csv.writer(open('../tsv/medium' + '.tsv', 'wb'), delimiter='\t')
  high = csv.writer(open('../tsv/high' + '.tsv', 'wb'), delimiter='\t')
  popular = csv.writer(open('../tsv/popular' + '.tsv', 'wb'), delimiter='\t')
  insane = csv.writer(open('../tsv/insane' + '.tsv', 'wb'), delimiter='\t')
